...
// ── Dashboard body (only shown when score is loaded) ─────────────────────────
      ...
      child: Column(
        ...
        children: [
                    ...
                    children: [
                      ...
                      Text(
                        score.total == 0
                            ...
                            : 'Verify more to increase your score',
            ...
            child: Column(
              children: [
                _ScoreRow(
                    ...
                    weight: '25%',
                    value: score.github,
                    done: score.github >= 1.0),
                const SizedBox(height: 12),
                _ScoreRow(
                    label: 'Badges',
                    weight: '30%',
                    value: score.badges,
                    done: score.badges >= 1.0),
                const SizedBox(height: 12),
                _ScoreRow(
                    label: 'Projects',
                    weight: '15%',
                    value: score.projects,
                    done: score.projects >= 1.0),
                const SizedBox(height: 12),
                _ScoreRow(
                    label: 'LeetCode',
                    weight: '15%',
                    value: score.leetcode,
                    done: false),
                const SizedBox(height: 12),
                _ScoreRow(
                    label: 'Experience',
          ...
          ...[
            _ActionItem(
              emoji: '🏅',
              title: 'JWT Auth badge detected',
              subtitle:
                  'Your CV mentions JWT — take a 5-min challenge to verify.',
              ctaLabel: 'Take Challenge',
              glowColor: AppTheme.accentGold,
              onTap: () =>
                  context.goNamed('badge-challenge', extra: 'JWT Auth'),
            ),
            if (!githubVerified)
              _ActionItem(
                emoji: '🔗',
          ...
          // ── Skills from CV ────────────────────────────────────────────────
          SectionHeader(
              title: 'Skills from your CV (${cv.skills.length})'),
          const SizedBox(height: 12),
          cv.skills.isEmpty
              ? AuctorCard(
                  child: Row(
                    children: [
                      ...
                      const SizedBox(width: 10),
                      Text(
                        'Upload your CV to extract skills',
                        style: Theme.of(context)
                            .textTheme
                            .bodyMedium
