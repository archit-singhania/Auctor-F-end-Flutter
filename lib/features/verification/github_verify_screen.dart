...
class _GithubVerifyScreenState extends ConsumerState<GithubVerifyScreen> {
  ...
  Future<void> _verify() async {
    ...
    setState(() { _isVerifying = true; _result = null; _errorMessage = null; });
      ...
      body: SafeArea(
        child: SingleChildScrollView(
          ...
          child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            AuctorCard(
              ...
              child: Row(children: [
                Container(
                  ...
                  child: const Icon(Icons.code_rounded, color: AppTheme.accentBlue, size: 24),
                ),
                const SizedBox(width: 16),
                Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                  Text('GitHub', style: Theme.of(context).textTheme.titleLarge),
                  Text('Verify repos & project history', style: Theme.of(context).textTheme.bodyMedium),
                ]),
              ]),
            ...
            Text('Enter your GitHub username', style: Theme.of(context).textTheme.titleMedium)
            ...
            if (_errorMessage != null) ...[
              ...
              Container(
                ...
                child: Row(children: [
                  const Icon(Icons.error_outline_rounded, color: AppTheme.accentRed, size: 16),
            ...
            ...[
              ...
              ('Stars & forks', 'Social proof of your work quality', false),
                  ...
                  child: AuctorCard(
                    child: Row(children: [
                      Icon(
                        item.$3 ? Icons.check_circle_rounded : Icons.timer_rounded,
                        size: 16,
                        color: item.$3 ? AppTheme.accentGreen : AppTheme.textSecondary,
                      ),
                      const SizedBox(width: 12),
                      Expanded(
                        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                          Text(item.$1, style: Theme.of(context).textTheme.titleMedium?.copyWith(fontSize: 14)),
    ...
    return AuctorCard(
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        Row(children: [
          ...
          Expanded(
            child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
              Text('@${result.username}', style: Theme.of(context).textTheme.titleMedium),
        ...
        if (result.matchedProjects.isNotEmpty) ...[
          ...
          Wrap(
            spacing: 6,
            children: result.matchedProjects.map((p) => SkillChip(skill: p, verified: true)).toList(),
          ),
        ],
      ]),
